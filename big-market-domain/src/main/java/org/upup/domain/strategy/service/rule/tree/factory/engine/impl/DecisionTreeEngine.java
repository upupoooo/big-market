package org.upup.domain.strategy.service.rule.tree.factory.engine.impl;

import lombok.extern.slf4j.Slf4j;
import org.upup.domain.strategy.model.vo.RuleLogicCheckTypeVO;
import org.upup.domain.strategy.model.vo.RuleTreeNodeLineVO;
...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Integer awardId) {
        ...
        while (null != nextNode) {
            ...
            // 决策节点计算
            DefaultTreeFactory.TreeActionEntity loginEntity = logicTreeNode.logic(userId, strategyId, awardId, ruleValue);
