...
public class LogicChainTest {
    ...
    public void test_LogicChain_rule_blacklist() {
        ...
        log.info("测试抽奖结果：{}", strategyAwardVO);
    }

    @Test
    public void test_LogicChain_rule_whitelist() {
        ILogicChain logicChain = defaultChainFactory.openLogicChain(100001L);
        DefaultChainFactory.StrategyAwardVO strategyAwardVO = logicChain.logic("upup", 100001L);
        log.info("测试抽奖结果：{}", strategyAwardVO.getAwardId());
    }
    ...
    public void test_LogicChain_rule_default() {
        ...
        ILogicChain logicChain = defaultChainFactory.openLogicChain(100001L);
        DefaultChainFactory.StrategyAwardVO strategyAwardVO = logicChain.logic("upup1", 100001L);
